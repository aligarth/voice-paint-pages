...
import { Mic, MicOff, Sparkles, ArrowLeft, Loader2, Palette, Ear, BookmarkPlus, Trash2, BookOpen, Camera, Check, RefreshCw, FileDown, FileArchive, ImageDown, Library, Eye, X, Pencil, Share2 } from "lucide-react";
